...
export const screenAwareProject = {
  title: "Screen-aware Workflows for Wispr Flow",
  shortTitle: "Screen-aware Workflows",
  eyebrow: "Independent multimodal AI product concept",
  status: "Interactive product concept",
  duration: "End-to-end meeting workflow",
  summary:
    "A consent-first product layer that connects meeting conversation to the screens and pointer context people share, then turns both into implementation-ready work.",
  question:
    "How could Wispr move beyond transcription to understand what was shown—and turn the meeting into work a team or agent can execute?",
  ...
  outputs: [
    "Visual implementation brief with screenshots and owners",
    "Short annotated recap with linked moments",
    "Agent-ready tasks, context, and acceptance criteria",
  ],
};
