export const site = {
  ...
  tableau: "https://public.tableau.com/app/profile/naman.jain3459/vizzes",
  calendly: "https://calendly.com/bnamanjain",
  linktree: "https://linktr.ee/bnamanjain",
...
export const proofMetrics = [
  {
    ...
    detail: "End-to-end post-purchase journey ownership",
  },
  {
    value: "₹6.5K → ₹7.5K",
    label: "realized customer LTV",
    detail: "Latest quarter versus the prior two-quarter baseline",
  },
  {
    value: "35% → 85%",
    label: "doctor-agent handoff",
    detail: "Across roughly 5,000 eligible patients per month",
  },
  {
    value: "21.7% → 16.7%",
    label: "doctor payout cost / revenue",
    detail: "Tiered payouts across 60+ doctors and ₹25L monthly volume",
  },
];

export const operatingEvidence = [
  {
    id: "repeat",
    number: "01",
    eyebrow: "Growth & lifecycle",
    title: "Built repeat into a measurable business line",
    summary:
      "Owned the post-first-purchase journey across fulfilment, treatment support, follow-up booking, reschedules, no-shows, and repurchase with a blended human-and-AI team.",
    metrics: ["33% → 45% revenue mix", "₹6.5K → ₹7.5K realized LTV"],
  },
  {
    id: "handoff",
    number: "02",
    eyebrow: "Conversion",
    title: "Rebuilt the doctor-to-purchase handoff",
    summary:
      "Added product guardrails and a doctor-agent workflow so patients understood their prescription and could move cleanly from consultation to purchase.",
    metrics: ["35% → 85% handoff", "~5,000 eligible patients / month"],
  },
  {
    id: "payouts",
    number: "03",
    eyebrow: "Fintech-adjacent platform",
    title: "Shipped an automated doctor payout product",
    summary:
      "Designed tiered payout economics, calculation and approval workflows, statements, payslips, and payment initiation in four weeks with a lean build team.",
    metrics: ["₹25L monthly volume", "21.7% → 16.7% cost / revenue"],
  },
  {
    id: "automation",
    number: "04",
    eyebrow: "AI & operations",
    title: "Used journey data to remove avoidable work",
    summary:
      "Audited WhatsApp journeys with AI-assisted workflows, fixed self-serve booking gaps, and deduplicated time-based calling tasks without losing customer context.",
    metrics: ["7,000 chats / month", "9,000 → 6,500 weekly tasks"],
  },
];

export const handshakeProject = {
  slug: "allo-handshake",
  title: "The 60-second Handshake",
  shortTitle: "Allo Handshake",
  eyebrow: "Shipped growth and operations case study",
  status: "Production impact",
  duration: "Funnel · UX · operations",
  summary:
    "A doctor-side exit intervention that kept first-time online follow-up patients on the call long enough for a care agent to join, explain fulfilment, and complete the handoff.",
  question:
    "How might we protect the highest-leverage handoff in a new online repeat-consultation journey?",
  links: {
    caseStudy: "/work/allo-handshake",
    prototype: "/work/allo-handshake#prototype",
  },
  highlights: [
    "Handshake rate: ~55% → ~90%",
    "Successful handshake: ~65% same-day conversion",
    "No handshake: ~35% same-day conversion",
  ],
};
...
export const screenAwareProject = {
  title: "Wispr Notetaker + Screen Context",
  shortTitle: "Wispr Screen Context",
  eyebrow: "Independent product review and concept",
  status: "Live product test",
  duration: "Research · strategy · prototype",
  summary:
    "Today, Wispr turns meeting audio into notes. I designed an optional layer that also saves the exact screen behind comments such as “change this banner,” so the final task is clear without a manual follow-up.",
  question:
    "How can Wispr connect what was said to the exact thing being shown on screen?",
  cover: "/assets/wispr-screen-workflows/current-gap-proposal.png",
  links: {
    caseStudy: "/work/wispr-screen-context",
    prototype:
      "https://bnamanjain.github.io/wispr-flow-screen-aware-workflows-concept/",
    github:
      "https://github.com/bnamanjain/wispr-flow-screen-aware-workflows-concept",
  },
  highlights: [
    "Today: transcript, summary, decisions, and action items",
    "Missing: which screen or component “this” refers to",
    "Proposal: link the comment to a screenshot, pointer, and owner",
  ],
};

export const healthcareSystemsProject = {
  slug: "healthcare-journey-systems",
  title: "Healthcare Journey Systems",
  eyebrow: "Sanitized production architecture study",
  summary:
    "How customer journeys become reliable production systems through explicit API contracts, workflow states, event-driven handoffs, schema decisions, observability, and failure recovery.",
  role:
    "Product ownership, system requirements, API and event contracts, state modelling, instrumentation, and engineering collaboration",
  status: "Production-informed · public-safe",
  duration: "Multi-journey systems study",
  cover: "/assets/healthcare-systems/system-context.svg",
  links: {
    caseStudy: "/work/healthcare-journey-systems",
  },
  chapters: [
    "API and integration contracts",
    "State, entity, and schema modelling",
    "Events, queues, and failure recovery",
