...
export const screenAwareProject = {
  title: "Wispr Notetaker: from notes to executable work",
  ...
  summary:
    "I tested Wispr Notetaker in a real product-review meeting, found where transcription loses visual decisions, and designed a consent-first Screen Context layer that turns those decisions into grounded work.",
  question:
    "How could Wispr preserve what was shown and pointed at—then turn the meeting into work a person or agent can actually execute?",
  cover: "/assets/wispr-screen-workflows/workflow-ready.png",
  links: {
  ...
  highlights: [
    "Separated Notetaker capture from the Fn dictation surface",
    "Grounded decisions in transcript, screen, and pointer evidence",
    "Designed a QA gate before work reaches people or agents",
  ],
};
